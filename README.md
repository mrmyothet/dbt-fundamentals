...
### [Intro to Data Build Tool (dbt) ](https://paing.blog/data_engineering/dbt/learning_path/1.intro_dbt)

### Reading
- [Lost in the Source: A Guide to Sources in dbt](https://thedataschool.com/edward-hayter/dbt_lost_in_the_source/)
- [Source properties](https://docs.getdbt.com/reference/source-properties#overview)
